...
from custom_utils.sensors import draw_lidar_around_point, check_collisions_between_tilemap_and_lines
...
while running:
    ...
    lines = draw_lidar_around_point(screen, sprite1.rect.x + sprite1.rect.width / 2, sprite1.rect.y + sprite1.rect.height / 2, 30, 100)
    collisions = check_collisions_between_tilemap_and_lines(gmap, lines)
    
    for i in range(len(collisions)):
        if collisions[i] is not None:
            pg.draw.circle(screen, (255, 0, 0), collisions[i], 3, 3)
